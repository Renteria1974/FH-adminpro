...
export class IncrementadorComponent implements OnInit
{
  ...
  // "@ViewChild() = Decorador
  // 'txtProgress' = Referencia al elemento HTML que deseamos manejar
  // txtprogress   = Nombre que le vamos a dar para poder manearlo aquí con TypeScript
  ...
  onChanges( nuevoValor: number )
  {
    ...
    // la declaramos del tipo "any" para uqe no marque error al usar su propiedad "value"
